...
mailer.notifyOwnerRequestFailed = function(request, callback){
	...
	var sendMail = function(request, callback){
	    ...
	    var message = "Hello,<br/><p>Your request did not return sufficient results. Please retry, and consider modifying the length of the sequence, or the dimensions of Helix I and III.<br/><br/>Regards,<br/>The Ribosoft Team</p><br/></br/><br/>Summary of request:</br>"+outputRequestInfo(request);
...
mailer.notifyOwners = function(requests, callback){
	...
	var sendMail = function(request, callback){
	    ...
	    var subject = "Result from Ribosoft for request "+request.uuid;
	    var message = "Hello,<br/><p>Your request has now been completed. You can view the results at the address: <a href='"+link+"' />"+link+"</a>.<br/><br/>Regards,<br/>The Ribosoft Team</p><br/></br/><br/>Summary of request:</br>"+outputRequestInfo(request);
